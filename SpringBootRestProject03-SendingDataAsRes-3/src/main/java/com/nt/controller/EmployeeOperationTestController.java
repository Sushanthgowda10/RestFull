...
public class EmployeeOperationTestController {
	...
	public ResponseEntity<String> getAllEmoployees() {
		...
		return new ResponseEntity<String>("GEt-Employee registration", HttpStatus.CREATED);
	...
	public ResponseEntity<String> updateEmailEmoployees() {
		...
		return new ResponseEntity<String>("PATCH-Employee email is updated", HttpStatus.CREATED);
	}
	...
	public ResponseEntity<String> deleteEmoployees() {
		...
		return new ResponseEntity<String>("DELETE-Employee deleted", HttpStatus.CREATED);
	}
}